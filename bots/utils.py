...
# - Decisions made
# - Action items with responsible persons and deadlines (if available)
# Be concise and clear to support quick understanding and follow-up.
# """
...
def file_summarizer(file_path: str) -> str:
    ...
    # Wait file state to ACTIVE
    start_time = time.time()
    while myfile.state != "ACTIVE":
        print(f"File is still in {myfile.state} state. Waiting 5 seconds...")
        time.sleep(5)
